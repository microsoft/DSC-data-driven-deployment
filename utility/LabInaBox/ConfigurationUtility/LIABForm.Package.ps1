...
function Show-LIABForm_psf {
	...
	$buttonFinish_Click = {
		...
		$liabConfig = [PsCustomobject]@{
			'Scriptlocation' = "$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabinaBox\Scripts";
			'DSCResourceDest' = 'C:\Program Files\WindowsPowerShell\Modules';
			'DSCResourceSource' = "$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabinaBox\DSCResources";
			'ParentFolderPath' = "$($cb_ParentDiskDrive.SelectedItem):\Program Files\LabinaBox\ParentVMDisks";
			'ParentFolderPathSource' = "$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabinaBox\ParentVMDisks";
			'ChildFolderPath' = "$($cb_ChildDiskDrive.SelectedItem):\Program Files\Labinabox\ChildVMDisks\$($tb_LabMachinePrefix.Text)";
			'ISOFolderPath' = "$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabinaBox\ISO";
			'DomainJoinPath' = "$($cb_ChildDiskDrive.SelectedItem):\Program Files\LabinaBox\ChildVMDisks\$($tb_LabMachinePrefix.Text)\DomainJoin";
		...
		$PSMainscript = "Import-module -name `"$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabInaBox\modules\LabinaBox.psm1`"`r"
		$PSCreatescript = $PSMainscript + "New-LabinaBox -configuration `"$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabinaBox\LabConfig\$($tb_LabMachinePrefix.Text)\$($tb_LabMachinePrefix.Text)_Config.json`" `r"
		$PSStopScript = $PSMainscript + "Stop-LabinaBox -configuration `"$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabinaBox\LabConfig\$($tb_LabMachinePrefix.Text)\$($tb_LabMachinePrefix.Text)_Config.json`" `r"
		$PSStartScript = $PSMainscript + "Start-LabinaBox -configuration `"$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabinaBox\LabConfig\$($tb_LabMachinePrefix.Text)\$($tb_LabMachinePrefix.Text)_Config.json`" `r"
		$PSUpdateScript = $PSMainscript + "Update-LabinaBox -configuration `"$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabinaBox\LabConfig\$($tb_LabMachinePrefix.Text)\$($tb_LabMachinePrefix.Text)_Config.json`" `r"
		$PSRemoveScript = $PSMainscript + "Remove-LabinaBox -configuration `"$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabinaBox\LabConfig\$($tb_LabMachinePrefix.Text)\$($tb_LabMachinePrefix.Text)_Config.json`" `r"
		$PSCheckPointScript = $PSMainscript + "CheckPoint-LabinaBox -configuration `"$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabinaBox\LabConfig\$($tb_LabMachinePrefix.Text)\$($tb_LabMachinePrefix.Text)_Config.json`" `r"
		$PSRemoveCheckPointScript = $PSMainscript + "Remove-LabinaBoxSnapshot -configuration `"$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabinaBox\LabConfig\$($tb_LabMachinePrefix.Text)\$($tb_LabMachinePrefix.Text)_Config.json`" `r"
		...
		if ($cb_DSCCentralHub.Checked -or $cb_AzureAutomation)
		{
			...
			if ($cb_DSCCentralHub.Checked)
			{
				...
				$PSCreatescript = $PSCreatescript + "New-DSCDataDrivenSQL -configuration `"$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabinaBox\LabConfig\$($tb_LabMachinePrefix.Text)\$($tb_LabMachinePrefix.Text)_Config.json`" -SQLConfiguration `"$($cb_ResourceDiskDrive.SelectedItem):\LabinaBox\LabConfig\$($tb_LabMachinePrefix.Text)\$($tb_LabMachinePrefix.Text)_SQLConfig.json`" -verbose `r"
				$PSCreatescript = $PSCreatescript + "Add-ServerConfigtoQueue -configuration `"$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabinaBox\LabConfig\$($tb_LabMachinePrefix.Text)\$($tb_LabMachinePrefix.Text)_Config.json`" -SQLConfiguration `"$($cb_ResourceDiskDrive.SelectedItem):\LabinaBox\LabConfig\$($tb_LabMachinePrefix.Text)\$($tb_LabMachinePrefix.Text)_SQLConfig.json`" -verbose"
			...
			If (!(Test-Path -Path "$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabInaBox\LabConfig\$($tb_LabMachinePrefix.Text)"))
			{ New-Item -ItemType Directory -Path "$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabInaBox\LabConfig\$($tb_LabMachinePrefix.Text)"}
			
			ConvertTo-Json -InputObject $sqlConfig | Out-File -FilePath "$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabInaBox\LabConfig\$($tb_LabMachinePrefix.Text)\$($tb_LabMachinePrefix.Text)_SQLConfig.json"
		...
		{
			New-Item -ItemType Directory -Force -Path "$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabInaBox\LabConfig\$($tb_LabMachinePrefix.Text)"
			ConvertTo-Json -InputObject $liabConfig | Out-File -FilePath "$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabInaBox\LabConfig\$($tb_LabMachinePrefix.Text)\$($tb_LabMachinePrefix.Text)_Config.json"
			$PSCreatescript | Out-File -FilePath "$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabInaBox\LabConfig\$($tb_LabMachinePrefix.Text)\$($tb_LabMachinePrefix.Text)_Create.ps1"
			$PSUpdatescript | Out-File -FilePath "$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabInaBox\LabConfig\$($tb_LabMachinePrefix.Text)\$($tb_LabMachinePrefix.Text)_Update.ps1"
			$PSStartScript | Out-File -FilePath "$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabInaBox\LabConfig\$($tb_LabMachinePrefix.Text)\$($tb_LabMachinePrefix.Text)_Start.ps1"
			$PSStopScript | Out-File -FilePath "$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabInaBox\LabConfig\$($tb_LabMachinePrefix.Text)\$($tb_LabMachinePrefix.Text)_Stop.ps1"
			$PSRemoveScript | Out-File -FilePath "$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabInaBox\LabConfig\$($tb_LabMachinePrefix.Text)\$($tb_LabMachinePrefix.Text)_Remove.ps1"
			$PSCheckPointScript | Out-File -FilePath "$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabInaBox\LabConfig\$($tb_LabMachinePrefix.Text)\$($tb_LabMachinePrefix.Text)_CheckPoint.ps1"
			$PSRemoveCheckPointScript | Out-File -FilePath "$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabInaBox\LabConfig\$($tb_LabMachinePrefix.Text)\$($tb_LabMachinePrefix.Text)_RemoveCheckPoint.ps1"
		...
		explorer "$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabInaBox\LabConfig\$($tb_LabMachinePrefix.Text)\"
	...
	$cb_ResourceDiskDrive_SelectedIndexChanged = {
		...
		$ISOFiles = $(get-childitem "$($cb_ResourceDiskDrive.SelectedItem):\Program Files\LabInaBox\ISO\").Name
